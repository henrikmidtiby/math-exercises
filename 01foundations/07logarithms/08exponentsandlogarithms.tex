...
\[
4^3 \cdot 9 \cdot 8^{-2} \cdot \left(\frac{1}{3}\right)^{-3}
 = 64 \cdot 9 \cdot \frac{1}{64} \cdot 3^3
\]
...
\hint
\[
= \frac{2^5 \cdot 8^2}{16 \cdot (1/16)} = 2^5 \cdot 8^2
\]
...
\hint
Benyt logaritmeregnereglen $\log(a) - \log(b) = \log(a/b)$ og forenk herefter.
