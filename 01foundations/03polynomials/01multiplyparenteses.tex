...
\answerbox{9x^2 + 18x + 4y^2 + 12y + 12xy + 9}
...
Gang parentesen ud
\[
(x^2 + y^2 + 1)(x^2 - y^2) = x^2 \cdot x^2 + x^2 \cdot (-y^2) + y^2 \cdot x^2 + y^2 \cdot (-y^2) + 1 \cdot x^2 + 1 \cdot (-y^2)
\]
...
Gang de første to parenteser ud
\[
(2x - 1)(2x - 2)(2x - 3) = ( (2x)(2x) + (2x)(-2) + (-1)(2x) + (-1)(-2) )(2x - 3)
\]
